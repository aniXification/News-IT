...
public class NewsList extends ListActivity {
	...
	public void retrieveNewsPosts() {
		...
		String new_url = url + "?page=" + current_page;
	...
	private class WebServiceTask extends AsyncTask<String, Integer, ArrayList<HashMap<String, String>>> {
		...
		protected void onPostExecute(final ArrayList<HashMap<String, String>> myList) {
			...
			try {
				ListAdapter adapter = new SimpleAdapter(NewsList.this, myList, R.layout.listitem, new String[] { "id", "title" },
				...
				Toast.makeText(NewsList.this, "The list cannot be populated. Please try again!!", Toast.LENGTH_LONG).show();
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
					...
					postDetailsInetnt.setClass(NewsList.this, NewsDetailsActivity.class);
					...
					Toast.makeText(NewsList.this, "selected id:" + pk, Toast.LENGTH_LONG).show();
					postDetailsInetnt.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
